{% macro render() %}
    ...
    {% block standfirst %}
        ...
        {{ standfirst.render(
            paragraph='2 Our industrial chemicals portfolio includes methanol, bio-methanol, and diesel exhaust fluid, each of which plays an increasingly important role in developing cleaner fuels.'
        ) }}
    {% endblock %}
