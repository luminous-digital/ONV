...
{% set availableItems = [
    { itemDate: '12 April 2019', itemTitle: 'Natgasoline LLC Begins', itemCat: 'Reports', itemUrl: '#' },
    { itemDate: '4 June 2018', itemTitle: 'Natgasoline LLC Stops', itemCat: 'Stocks', itemUrl: '#' },
    { itemDate: '8 June 2017', itemTitle: 'Natgasoline LLC Does something', itemCat: 'Stocks', itemUrl: '#' }
] %}
    ...
    <section class="l-section">
        <div class="l-inner">
            ...
            <div class="c-list-wrapper c-list-wrapper--offset-top js-list">
                <div class="c-list-wrapper__filters">
                    <ul class="c-list-filters">
                        <li class="c-list-filters__item">
                            <div class="c-dropdown c-dropdown--small js-map-filter" data-filter-type="facility" data-chosen-option="">
                ...
                <div class="c-list-wrapper__list">
                    <ul class="c-file-list js-list-items{% if twoColumns %} c-file-list--two-columns {% endif %}">
                        {% for item in availableItems %}
                            <li class="c-file-list__item" data-cat="{{ item.itemCat }}">
